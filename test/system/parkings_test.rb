...
class ParkingsTest < ApplicationSystemTestCase
  ...
  test "creating a Parking" do
    ...
    fill_in "No Of Vehicles", with: @parking.no_of_vehicles
    fill_in "Number", with: @parking.number
    fill_in "Owner Name", with: @parking.owner_name
    fill_in "Place", with: @parking.place
    fill_in "Timing", with: @parking.timing
    fill_in "Vehicle Name", with: @parking.vehicle_name
